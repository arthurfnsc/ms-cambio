...
class CodificacaoTest {
    ...
    companion object {
        ...
        private val USE_JUNIT4 = dependOnClassesThat(
    ...
    @ArchTest
    private fun `classes não devem utilizar o JUnit 4`(classes: JavaClasses) {
        noClasses().should(USE_JUNIT4).check(classes)
    }
